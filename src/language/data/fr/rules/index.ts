...
export const rules: Rules = {
    field: {
        ...
        minLength: (minLength) => `Ce champ doit comporter au moins ${minLength} caractères.`,
        maxLength: (maxLength) => `Ce champ ne doit pas dépasser ${maxLength} caractères.`,
    },
    number: {
        positive: "Veuillez entrer un nombre positif.",
        invalid: "Veuillez entrer un nombre valide.",
        minValue: (minValue) => `Veuillez entrer un nombre supérieur ou égal à ${minValue}.`,
        maxValue: (maxValue) => `Veuillez entrer un nombre inférieur ou égal à ${maxValue}.`,
