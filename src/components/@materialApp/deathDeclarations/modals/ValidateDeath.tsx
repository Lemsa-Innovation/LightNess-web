...
function ValidateDeathModal({matchedUid, docPaths, disclosureProps}: {
  matchedUid: string
  docPaths: string[]
  ...
  const action = languageData?.inputs.deathDeclarations.actions.validateDeclaration
...
export default ValidateDeathModal;