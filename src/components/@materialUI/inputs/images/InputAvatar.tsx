...
const InputAvatar: React.FC<AvatarProps> = ({
    ...
    const defaultImagePlaceholder = useLanguage().languageData?.inputs.attachements.media.image.placeholder
    ...
    const classname = cn(
        ...
        src ? 'opacity-0 text-white bg-gray-900' : 'bg-foreground-100 text-foreground-800'
    )
    return (
        <div
            className={cn(
        ...
        >
            ...
            >
                <CameraIcon size={26} />
                <p color="currentColor" className={'p-1 text-center text-tiny select-none'}>
