      ...
      <Checkbox
        ...
        classNames={{
          base: cn(
            ...
            isBordered &&
              "border-2 rounded-xl border-foreground-200 hover:border-foreground-400",
            align === "start" && "items-start"
          ),
        }}
      >
        <p className={cn(isDefaultText && "text-foreground-500", "text-base ")}>
          {label ?? field?.label}
        </p>
