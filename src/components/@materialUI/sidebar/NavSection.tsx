...
import {Alarm, DocumentText, Home2, LocationDiscover, Moneys, ReceiptMinus, Send2, Setting2} from "iconsax-react";
...
const NavSection: React.FC<{isCollapsed: boolean}> = ({isCollapsed}) => {
	...
	const match = (path: string) => (path ? pathname.startsWith(path) : false);
